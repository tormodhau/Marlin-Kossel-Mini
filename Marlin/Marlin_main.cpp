...
void deploy_z_probe() {
  ...
  destination[X_AXIS] = 20; // T3P3 Kossel Mini DEFAULT 30
  destination[Y_AXIS] = 45; // T3P3 Kossel Mini DEFAULT 96
  destination[Z_AXIS] = 50; // DEFAULT 50
  prepare_move_raw();

  feedrate = homing_feedrate[X_AXIS]/10;
  destination[X_AXIS] = 20; // T3P3 Kossel Mini  DEFAULT 7
  prepare_move_raw();
  st_synchronize();
}
...
void retract_z_probe() {
  ...
  destination[X_AXIS] = -60.10;  //DEFAULT-61 LAST -56.90
  destination[Y_AXIS] = 63.60;   //DEFAULT 66 LAST 61.90
  destination[Z_AXIS] = 20.00;   //DEFAULT 35 LAST 28.60
  prepare_move_raw();

  // Move the nozzle below the print surface to push the probe up.
  feedrate = homing_feedrate[Z_AXIS]/10;
  destination[Z_AXIS] = current_position[Z_AXIS] - 15; // DEFAULT - 30 LAST -14
  prepare_move_raw();
